namespace CustomCode.Test.BehaviorDrivenDevelopment.Tests
{
    ...
    /// <summary>
    /// Test cases for the <see cref="DecimalInverseValidator"/> type.
    /// </summary>
    [UnitTest]
    [Category("Assert", "DecimalValidation")]
    public sealed class DecimalInverseValidatorTest
    {
        ...
        [Fact(DisplayName = "decimal.NotBeNegative()")]
        public void ValidateDecimalNotToBeNegativeViolated()
        {
            // Given
            var validator = new DecimalInverseValidator(-42);
