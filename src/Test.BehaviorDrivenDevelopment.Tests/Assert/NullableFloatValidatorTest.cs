namespace CustomCode.Test.BehaviorDrivenDevelopment.Tests
{
    ...
    /// <summary>
    /// Test cases for the <see cref="NullableFloatValidator"/> type.
    /// </summary>
    [UnitTest]
    [Category("Assert", "FloatValidation")]
    public sealed class NullableFloatValidatorTest
    {
        #region float?.Be()
        ...
        {
            // Given
            var validator = new NullableFloatValidator(42);
        ...
        [Fact(DisplayName = "float?.Be(null)")]
        public void ValidateFloatToBeNull()
        {
            // Given
            var validator = new NullableFloatValidator(null);
        ...
        {
            // Given
            var validator = new NullableFloatValidator(42.12345f);
        ...
        public void ValidateNullableFloatToBeApproximatelyValueViolated()
        {
            // Given
            var validator = new NullableFloatValidator(null);
        ...
        [Fact(DisplayName = "float?.BeBetween(wrongMinimum, wrongMaximum)")]
        public void ValidateNullableFloatToBeBetweenValuesMinimumAndMaximumViolated()
        {
            // Given
            var validator = new NullableFloatValidator(null);
        ...
        [Fact(DisplayName = "float?.BeGreaterThan(wrongMinimum)")]
        public void ValidateNullableFloatToBeGreaterThanValueViolated()
        {
            // Given
            var validator = new NullableFloatValidator(null);
        ...
        [Fact(DisplayName = "float?.BeGreaterThanOrEqualTo(wrongMinimum)")]
        public void ValidateNullableFloatToBeGreaterThanOrEqualToValueViolated()
        {
            // Given
            var validator = new NullableFloatValidator(null);
        ...
        [Fact(DisplayName = "float?.BeLessThan(wrongMinimum)")]
        public void ValidateNullableFloatToBeLessThanValueViolated()
        {
            // Given
            var validator = new NullableFloatValidator(null);
        ...
        [Fact(DisplayName = "float?.BeLessThanOrEqualTo(wrongMaximum)")]
        public void ValidateNullableFloatToBeLessThanOrEqualToValueViolated()
        {
            // Given
            var validator = new NullableFloatValidator(null);
        ...
        {
            // Given
            var validator = new NullableFloatValidator(0);
        ...
        [Fact(DisplayName = "float?.BeNull()")]
        public void ValidateNullableFloatToBeNull()
        {
            // Given
            var validator = new NullableFloatValidator(null);
        ...
        [Fact(DisplayName = "float?.BeNull()")]
        public void ValidateNullableFloatToBeNullViolated()
        {
            // Given
            var validator = new NullableFloatValidator(0);
        ...
        [Fact(DisplayName = "float?.BeNull(reason)")]
        ...
        [Fact(DisplayName = "float?.BeOneOf(float?, float?)")]
        public void ValidateNullableFloatToBeOneOfExpectedValues()
        {
            // Given
            var validator = new NullableFloatValidator(null);

            // When
            validator.BeOneOf(new float?[] { 10, null });
