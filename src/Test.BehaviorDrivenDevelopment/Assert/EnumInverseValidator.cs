namespace CustomCode.Test.BehaviorDrivenDevelopment
{
    ...
    /// <summary>
    /// A validator that defines inverse assertions for <see cref="System.Enum"/> data types.
    /// </summary>
    /// <typeparam name="T"> The type of the enumeration value. </typeparam>
    public struct EnumInverseValidator<T> : IFluentInterface
        where T : System.Enum
    {
        #region Dependencies

        /// <summary>
        /// Creates a new instance of the <see cref="EnumInverseValidator{T}"/> type.
        /// </summary>
        /// <param name="value"> The enumeration value to be validated. </param>
        public EnumInverseValidator(T value)
        {
        ...
        /// <summary>
        /// Assert that a given enumeration value does not equal another enumeration value.
        /// </summary>
