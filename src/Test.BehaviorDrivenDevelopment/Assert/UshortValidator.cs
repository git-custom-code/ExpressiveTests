namespace CustomCode.Test.BehaviorDrivenDevelopment
{
    ...
    /// <summary>
    /// A validator that defines assertions for the <see cref="ushort"/> data type.
    /// </summary>
    public struct UshortValidator : IFluentInterface
    {
        #region Dependencies

        /// <summary>
        /// Creates a new instance of the <see cref="UshortValidator"/> type.
        /// </summary>
        /// <param name="value"> The unsigned short value to be validated. </param>
        public UshortValidator(ushort value)
        {
        ...
        /// <summary>
        /// Assert that a given unsigned short equals another unsigned short.
        /// </summary>
        ...
        /// <summary>
        /// Assert that a given unsigned short is between (or equal to) a specified minimum and maximum value.
        /// </summary>
        ...
        /// <summary>
        /// Assert that a given unsigned short is greater than a minimum value.
        /// </summary>
        /// <param name="minimum"> The allowed minimum value for the unsigned short. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given unsigned short is greater than or equal to a minimum value.
        /// </summary>
        /// <param name="minimum"> The allowed minimum value for the unsigned short. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given unsigned short is less than a maximum value.
        /// </summary>
        /// <param name="maximum"> The allowed maximum value for the unsigned short. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given unsigned short is less than or equal to a maximum value.
        /// </summary>
        /// <param name="maximum"> The allowed maximum value for the unsigned short. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given unsigned short matches one of the expected values.
        /// </summary>
