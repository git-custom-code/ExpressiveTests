namespace CustomCode.Test.BehaviorDrivenDevelopment
{
    ...
    /// <summary>
    /// A validator that defines assertions for the nullable <see cref="int"/> data type.
    /// </summary>
    public struct NullableIntValidator : IFluentInterface
    {
        #region Dependencies

        /// <summary>
        /// Creates a new instance of the <see cref="NullableIntValidator"/> type.
        /// </summary>
        /// <param name="value"> The nullable integer value to be validated. </param>
        public NullableIntValidator(int? value)
        {
        ...
        /// <summary>
        /// Assert that a given nullable integer equals another nullable integer.
        /// </summary>
        ...
        /// <summary>
        /// Assert that a given nullable integer is between (or equal to) a specified minimum and maximum value.
        /// </summary>
        ...
        /// <summary>
        /// Assert that a given nullable integer is greater than a minimum value.
        /// </summary>
        /// <param name="minimum"> The allowed minimum value for the nullable integer. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given nullable integer is greater than or equal to a minimum value.
        /// </summary>
        /// <param name="minimum"> The allowed minimum value for the nullable integer. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given nullable integer is less than a maximum value.
        /// </summary>
        /// <param name="maximum"> The allowed maximum value for the nullable integer. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given nullable integer is less than or equal to a maximum value.
        /// </summary>
        /// <param name="maximum"> The allowed maximum value for the nullable integer. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given nullable integer has a negative value (less than zero).
        /// </summary>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        /// <param name="lineNumber"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given nullable integer is null.
        /// </summary>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        /// <param name="lineNumber"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given nullable integer matches one of the expected values.
        /// </summary>
        ...
        /// <summary>
        /// Assert that a given nullable integer has a positive value (greater than or equal to zero).
        /// </summary>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        /// <param name="lineNumber"> Supplied by the compiler. </param>
