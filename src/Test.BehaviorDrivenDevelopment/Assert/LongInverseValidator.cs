namespace CustomCode.Test.BehaviorDrivenDevelopment
{
    ...
    /// <summary>
    /// A validator that defines inverse assertions for the <see cref="long"/> data type.
    /// </summary>
    public struct LongInverseValidator : IFluentInterface
    {
        #region Dependencies

        /// <summary>
        /// Creates a new instance of the <see cref="LongInverseValidator"/> type.
        /// </summary>
        /// <param name="value"> The long value to be validated. </param>
        public LongInverseValidator(long value)
        {
        ...
        /// <summary>
        /// Gets the long value to be validated.
        /// </summary>
        ...
        /// <summary>
        /// Assert that a given long doese not equal another long.
        /// </summary>
        /// <param name="expected"> The expected value of a given long. </param>
        ...
        /// <summary>
        /// Assert that a given long is not between (or equal to) a specified minimum and maximum value.
        /// </summary>
        /// <param name="minimum"> The allowed minimum value for the long. </param>
        /// <param name="maximum"> The allowed maximum value for the long. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        /// <param name="lineNumber"> Supplied by the compiler. </param>
        /// <param name="sourceCodePath"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given long is not greater than a minimum value.
        /// </summary>
        /// <param name="minimum"> The allowed minimum value for the long. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given long is not greater than or equal to a minimum value.
        /// </summary>
        /// <param name="minimum"> The allowed minimum value for the long. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given long is not less than a maximum value.
        /// </summary>
        /// <param name="maximum"> The allowed maximum value for the long. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given long is not less than or equal to a maximum value.
        /// </summary>
        /// <param name="maximum"> The allowed maximum value for the long. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given long does not have a negative value (less than zero).
        /// </summary>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        /// <param name="lineNumber"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given long does not match one of the expected values.
        /// </summary>
        ...
        /// <summary>
        /// Assert that a given long does not have a positive value (greater than or equal to zero).
        /// </summary>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        /// <param name="lineNumber"> Supplied by the compiler. </param>
