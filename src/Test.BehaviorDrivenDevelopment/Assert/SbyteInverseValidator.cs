namespace CustomCode.Test.BehaviorDrivenDevelopment
{
    ...
    /// <summary>
    /// A validator that defines inverse assertions for the <see cref="sbyte"/> data type.
    /// </summary>
    public struct SbyteInverseValidator : IFluentInterface
    {
        #region Dependencies

        /// <summary>
        /// Creates a new instance of the <see cref="SbyteInverseValidator"/> type.
        /// </summary>
        /// <param name="value"> The signed byte value to be validated. </param>
        public SbyteInverseValidator(sbyte value)
        {
        ...
        /// <summary>
        /// Assert that a given signed byte doese not equal another signed byte.
        /// </summary>
        ...
        /// <summary>
        /// Assert that a given signed byte is not between (or equal to) a specified minimum and maximum value.
        /// </summary>
        ...
        /// <summary>
        /// Assert that a given signed byte is not greater than a minimum value.
        /// </summary>
        /// <param name="minimum"> The allowed minimum value for the signed byte. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given signed byte is not greater than or equal to a minimum value.
        /// </summary>
        /// <param name="minimum"> The allowed minimum value for the signed byte. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given signed byte is not less than a maximum value.
        /// </summary>
        /// <param name="maximum"> The allowed maximum value for the signed byte. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given signed byte is not less than or equal to a maximum value.
        /// </summary>
        /// <param name="maximum"> The allowed maximum value for the signed byte. </param>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given signed byte does not have a negative value (less than zero).
        /// </summary>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        /// <param name="lineNumber"> Supplied by the compiler. </param>
        ...
        /// <summary>
        /// Assert that a given signed byte does not match one of the expected values.
        /// </summary>
        ...
        /// <summary>
        /// Assert that a given signed byte does not have a positive value (greater than or equal to zero).
        /// </summary>
        /// <param name="because"> A reason why this assertion needs to be correct. </param>
        /// <param name="testMethodName"> Supplied by the compiler. </param>
        /// <param name="lineNumber"> Supplied by the compiler. </param>
